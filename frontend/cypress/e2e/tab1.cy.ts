describe('Tab 1 - Home Page', () => {
  ...
  it('should default to the About Us section on page load', () => {
    cy.get('ion-segment-button[value="about-us"]').should('have.class', 'segment-button-checked');
  ...
  it('should verify the image slider contains the correct number of images', () => {
