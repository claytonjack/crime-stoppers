describe('Volunteer Page', () => {
    ...
    it('should render the "How to Apply" steps', () => {
        ...
        cy.contains('.info-content', 'Select the button below to download').should('exist');
        cy.contains('.info-content', 'Fill out all sections of the application').should('exist');
