...
describe('ContactPage', () => {
  ...
  it('should render main contact sections', () => {
    ...
    expect(sections.length).toBe(2); // General Inquiries + Board of Directors
    expect(sections[0].textContent).toContain('feature.contact.sections.generalInquiries.title');
    expect(sections[1].textContent).toContain('feature.contact.sections.board.title');
  });
});
