...
import {
  ...
  IonItemDivider, IonText, IonButton
} from '@ionic/angular/standalone';

// ---- Standalone Translate Pipe Mock ----
...
describe('VolunteerPage', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [
        ...
        IonItem, IonLabel, IonItemDivider, IonText, IonButton,
      ],
      providers: [
  ...
  it('should render "Why Join Our Team" heading', () => {
    ...
    expect(title.nativeElement.textContent).toContain('feature.volunteer.hero.title');
  });
  ...
  it('should render hero content', () => {
    ...
    expect(content.nativeElement.textContent)
      .toContain('feature.volunteer.hero.description');
  });

  it('should render application steps', () => {
    const steps = fixture.debugElement.queryAll(By.css('.info-header ion-label'));
    expect(steps.length).toBe(3);

    const labels = steps.map(
      lbl => lbl.nativeElement.textContent.trim()
    );
