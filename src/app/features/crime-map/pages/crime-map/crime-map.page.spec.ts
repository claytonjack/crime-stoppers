...
describe('CrimeMapPage', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      imports: [CrimeMapPage, TranslateModule.forRoot()], // <-- provide TranslateService
      providers: [{ provide: ScreenReaderService, useValue: spy }],
    }).compileComponents();

    screenReaderSpy = TestBed.inject(ScreenReaderService) as jasmine.SpyObj<ScreenReaderService>;
  }));
  ...
  it('should call screen reader on ngOnInit', async () => {
    ...
    expect(screenReaderSpy.speak).toHaveBeenCalledWith('Crime Map page loaded.');
