...
describe('TabMenuComponent', () => {
  ...
  beforeEach(async () => {
    ...
    const privacyModeSpy = jasmine.createSpyObj('PrivacyModeService', [], { 
      isEnabled: false,
      isEnabled$: of(false) // observable mocked
    });
    ...
    privacyModeService = TestBed.inject(PrivacyModeService) as jasmine.SpyObj<PrivacyModeService>;

    // Directly assign observable value to avoid async pipe
